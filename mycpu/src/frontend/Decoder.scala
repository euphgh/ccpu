...
object AllInsts {
  def apply(): Seq[Tuple2[chisel3.util.BitPat, List[chisel3.ChiselEnum#Type]]] = {
    Seq(
      ...
      TLBP  -> List(SRCType.noSRC, DSTType.noDST, ChiselFuType.MDU, MduType.TLBP),
      TLBR  -> List(SRCType.noSRC, DSTType.noDST, ChiselFuType.MDU, MduType.TLBR),
      TLBWI -> List(SRCType.noSRC, DSTType.noDST, ChiselFuType.MDU, MduType.TLBWI),
